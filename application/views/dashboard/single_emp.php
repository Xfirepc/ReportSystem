                            ...
                            <div class="user-bg" style="min-height: 400px;">
                                  <div class="overlay-box" style="background: #aeaeae;">
                                    <div class="user-content">
                                        <img src="<?= base_url()?>plantilla/dashboard/plugins/images/users/<?= !empty($profile->img) ? $profile->img : 'varun.jpg' ?>" class=" img-circle" alt="img">
